...
class EnvSetup:
    ...
    def setup_ffmpeg(self):
        ...
        default_paths = [
            ...
            "C:\\Users\\{}\\AppData\\Local\\Microsoft\\WinGet\\Packages\\Gyan.FFmpeg_Microsoft.Winget.Source_8wekyb3d8bbwe\\ffmpeg-8.0.1-full_build\\bin\\ffmpeg.exe".format(os.getenv('USERNAME', 'User'))
        ]
